...
class TestCredentials:
    def test_credentials_initialization(self) -> None:
        ...
        creds = Credentials(email="test@example.com", password=PASSWORD, user_id="12345", company_id="67890")
    ...
    def test_password_encryption(self) -> None:
        ...
        creds = Credentials(email="test@example.com", password=original_password, user_id="12345", company_id="67890")
    ...
    def test_already_encrypted_password(self) -> None:
        ...
        creds1 = Credentials(email="test@example.com", password=original_password, user_id="12345", company_id="67890")
        encrypted_password = creds1.password

        # Now create new credentials with the encrypted password
        creds2 = Credentials(email="test@example.com", password=encrypted_password, user_id="12345", company_id="67890")
    ...
    def test_invalid_credentials(self) -> None:
        ...
        with pytest.raises(ValueError):
            Credentials(email="not_an_email", password=PASSWORD, user_id="12345", company_id="67890")

        with pytest.raises(ValueError):
            Credentials(email="test@example.com", password="", user_id="12345", company_id="67890")
    ...
    def test_valid_email_formats(self) -> None:
        ...
        for email in valid_emails:
            Credentials(email=email, password=PASSWORD, user_id="12345", company_id="67890")
