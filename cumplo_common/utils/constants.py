...
DEFAULT_EXPIRATION_MINUTES: int = int(getenv("DEFAULT_EXPIRATION_MINUTES", "60"))
...
DICOM_STRINGS: list[str] = ["CON DICOM", "CONDICOM", "PRESENTA DICOM"]
SIMULATION_AMOUNT = int(getenv("SIMULATION_AMOUNT", "1000000"))
